...
This is a simple web application which can be used to find the Pokemon on the basis of their types.
This application is made with the help of simple concepts of HTML,CSS and JS.

## How to use 

This application is used as there are some segments on which it is used.The segments are mentioned as below:

1. Select the type of Pokemon (eg:water,air,grass etc.) from the type list.

2. By selecting the type of the Pokemon we can select the "Filter by Type" button which helps to get Pokemon on their type which we choosed.

3. We can also find the Pokemons with the help of their names by entering their name in the "Enter the Name" section.

4. Lastly we can reset the application for the new searches with the help of "Reset" button.

## Creation of Application 

This application can be created with some easy and simple steps which are mentioned as below:-

**Step-1**: **Create a New HTML File**

A new HTML file is created and it is saved as index.html.The following code is to be added to your HTML file:
